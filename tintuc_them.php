...
{
	$sql = "INSERT INTO `tintuc`(`Hinhanh`,`Tieude`, `ID_danhmuc`, `ID_nguoidung`, `Ngaydang`, `Tomtat`, `Noidung`) 
	VALUES ('$Hinhanh','$Tieude',$ID_danhmuc,$ID_nguoidung,now(),'$Tomtat','$Noidung')";
					...
					<form method="post" action="tintuc_them.php">
						...
						<div class="form-group">
							...
							<div class="input-group mb-2 mb-sm-0">
								...
								<input type="text" class="form-control" id="Hinhanh" name="Hinhanh" placeholder="" required />
