...
<nav class="navbar navbar-expand-lg navbar-Secondary" style="background-color:#064762;">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                ...
                <a class="dropdown-item" href="nguoidung.php">Quản lý người dùng</a>
                 ...
                 <a class="dropdown-item" href="#">Quản lý công văn đi</a>
               <a class="dropdown-item" href="#">Quản lý công văn đến</a>
              </div>
            </li>
      <?php
          }
    ...
    <form class="form-inline my-2 my-lg-0" method="post" action="timkiem.php">
